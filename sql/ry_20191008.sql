...
Target Server Type    : MYSQL12
Target Server Version : 800311
File Encoding         : 65001

Date: 2022-10-14 14:02:12 11
*/
...
-- ----------------------------
INSERT INTO `gen_table` VALUES ('1', 'sys_order', '', 'SysOrder', 'crud', 'com.ruoyi.system', 'system', 'order', null, 'ruoyi', null, 'admin', '2022-10-13 16:58:58', '', null, null);
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='代码生成业务表字段';

-- ----------------------------
-- Records of gen_table_column
-- ----------------------------
INSERT INTO `gen_table_column` VALUES ('1', '1', 'id', null, 'int', 'Long', 'id', '1', '0', null, '1', null, null, null, 'EQ', 'input', '', '1', 'admin', '2022-10-13 16:58:58', '', null);
INSERT INTO `gen_table_column` VALUES ('2', '1', 'status', null, 'int', 'Long', 'status', '0', '0', null, '1', '1', '1', '1', 'EQ', 'radio', '', '2', 'admin', '2022-10-13 16:58:58', '', null);
INSERT INTO `gen_table_column` VALUES ('3', '1', 'code', null, 'varchar(32)', 'String', 'code', '0', '0', null, '1', '1', '1', '1', 'EQ', 'input', '', '3', 'admin', '2022-10-13 16:58:58', '', null);
INSERT INTO `gen_table_column` VALUES ('4', '1', 'candidateName', null, 'varchar(32)', 'String', 'candidatename', '0', '0', null, '1', '1', '1', '1', 'LIKE', 'input', '', '4', 'admin', '2022-10-13 16:58:58', '', null);
INSERT INTO `gen_table_column` VALUES ('5', '1', 'pdfPath', '报告地址', 'varchar(128)', 'String', 'pdfpath', '0', '0', null, '1', '1', '1', '1', 'EQ', 'input', '', '5', 'admin', '2022-10-13 16:58:58', '', null);
INSERT INTO `gen_table_column` VALUES ('6', '1', 'create_time', null, 'datetime', 'Date', 'createTime', '0', '0', null, '1', null, null, null, 'EQ', 'datetime', '', '6', 'admin', '2022-10-13 16:58:58', '', null);
INSERT INTO `gen_table_column` VALUES ('7', '1', 'update_time', null, 'datetime', 'Date', 'updateTime', '0', '0', null, '1', '1', null, null, 'EQ', 'datetime', '', '7', 'admin', '2022-10-13 16:58:58', '', null);
INSERT INTO `gen_table_column` VALUES ('8', '1', 'menu_id', null, 'int', 'Long', 'menuId', '0', '0', null, '1', '1', '1', '1', 'EQ', 'input', '', '8', 'admin', '2022-10-13 16:58:58', '', null);
INSERT INTO `gen_table_column` VALUES ('9', '1', 'deliver_id', null, 'int', 'Long', 'deliverId', '0', '0', null, '1', '1', '1', '1', 'EQ', 'input', '', '9', 'admin', '2022-10-13 16:58:58', '', null);
INSERT INTO `gen_table_column` VALUES ('10', '1', 'customer_id', null, 'int', 'Long', 'customerId', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'input', '', '10', 'admin', '2022-10-13 16:58:58', '', null);
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'USERCHI-A8RE1G71665727174054', '1665727326949', '15000');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', null, '1665727180000', '-1', '5', 'PAUSED', 'CRON', '1665727174000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', null, '1665727185000', '-1', '5', 'PAUSED', 'CRON', '1665727174000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', null, '1665727180000', '-1', '5', 'PAUSED', 'CRON', '1665727174000', '0', null, '2', '');
...
CREATE TABLE `sys_dept` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`dept_id`)
) ENGINE=InnoDB AUTO_INCREMENT=201 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='部门表';

-- ----------------------------
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES ('100', '0', '0', '背调科技', '0', '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2022-10-13 15:58:54');
INSERT INTO `sys_dept` VALUES ('101', '100', '0,100', '背调总公司', '1', '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2022-10-13 15:39:50');
...
INSERT INTO `sys_dept` VALUES ('200', '101', '0,100,101', '交付部', '1', null, null, null, '0', '0', 'admin', '2022-10-13 15:40:04', '', null);
...
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='字典数据表';
...
INSERT INTO `sys_dict_data` VALUES ('100', '0', '待授权', '2', 'sys_order_status', null, 'default', 'Y', '0', 'admin', '2022-10-13 16:36:46', '', null, null);
INSERT INTO `sys_dict_data` VALUES ('101', '1', '调查中', '3', 'sys_order_status', null, null, 'Y', '0', 'admin', '2022-10-13 16:37:05', '', null, null);
...
INSERT INTO `sys_dict_type` VALUES ('100', '订单状态', 'sys_order_status', '0', 'admin', '2022-10-13 16:35:08', 'admin', '2022-10-13 18:07:19', '订单状态列表');
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='系统访问记录';

-- ----------------------------
-- Records of sys_logininfor
-- ----------------------------
INSERT INTO `sys_logininfor` VALUES ('1', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '退出成功', '2022-10-13 15:42:42');
INSERT INTO `sys_logininfor` VALUES ('2', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '1', '密码输入错误1次', '2022-10-13 15:42:46');
INSERT INTO `sys_logininfor` VALUES ('3', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 15:42:49');
INSERT INTO `sys_logininfor` VALUES ('4', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '退出成功', '2022-10-13 15:52:35');
INSERT INTO `sys_logininfor` VALUES ('5', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 15:52:37');
INSERT INTO `sys_logininfor` VALUES ('6', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '退出成功', '2022-10-13 15:53:57');
INSERT INTO `sys_logininfor` VALUES ('7', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '1', '用户已封禁，请联系管理员', '2022-10-13 15:54:00');
INSERT INTO `sys_logininfor` VALUES ('8', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 15:54:08');
INSERT INTO `sys_logininfor` VALUES ('9', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 16:26:26');
INSERT INTO `sys_logininfor` VALUES ('10', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 16:38:00');
INSERT INTO `sys_logininfor` VALUES ('11', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 16:46:33');
INSERT INTO `sys_logininfor` VALUES ('12', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 16:57:59');
INSERT INTO `sys_logininfor` VALUES ('13', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 17:05:35');
INSERT INTO `sys_logininfor` VALUES ('14', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 17:12:58');
INSERT INTO `sys_logininfor` VALUES ('15', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 17:14:55');
INSERT INTO `sys_logininfor` VALUES ('16', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 17:20:26');
INSERT INTO `sys_logininfor` VALUES ('17', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '退出成功', '2022-10-13 18:03:06');
INSERT INTO `sys_logininfor` VALUES ('18', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '1', '密码输入错误1次', '2022-10-13 18:03:14');
INSERT INTO `sys_logininfor` VALUES ('19', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 18:03:17');
INSERT INTO `sys_logininfor` VALUES ('20', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '退出成功', '2022-10-13 18:03:33');
INSERT INTO `sys_logininfor` VALUES ('21', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 18:03:35');
INSERT INTO `sys_logininfor` VALUES ('22', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '退出成功', '2022-10-13 18:08:41');
INSERT INTO `sys_logininfor` VALUES ('23', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '1', '密码输入错误1次', '2022-10-13 18:08:50');
INSERT INTO `sys_logininfor` VALUES ('24', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 18:08:54');
INSERT INTO `sys_logininfor` VALUES ('25', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '退出成功', '2022-10-13 18:10:25');
INSERT INTO `sys_logininfor` VALUES ('26', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 18:10:27');
INSERT INTO `sys_logininfor` VALUES ('27', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '退出成功', '2022-10-13 18:15:03');
INSERT INTO `sys_logininfor` VALUES ('28', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 18:15:06');
INSERT INTO `sys_logininfor` VALUES ('29', 'admin', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '退出成功', '2022-10-13 18:15:16');
INSERT INTO `sys_logininfor` VALUES ('30', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '1', '密码输入错误1次', '2022-10-13 18:15:24');
INSERT INTO `sys_logininfor` VALUES ('31', 'jiaofu', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', '0', '登录成功', '2022-10-13 18:15:28');
...
INSERT INTO `sys_menu` VALUES ('2000', '订单列表', '1', '9', '/system/order', 'menuItem', 'C', '0', 'system:order:view', '#', 'admin', '2022-10-13 16:12:05', 'admin', '2022-10-13 16:22:46', '');
INSERT INTO `sys_menu` VALUES ('2001', '订单列表', '2', '1', '#', 'menuItem', 'F', '0', 'system:order:list', '#', 'admin', '2022-10-13 18:13:39', '', null, '');
INSERT INTO `sys_menu` VALUES ('2002', '订单列表查询', '2000', '1', '#', 'menuItem', 'F', '0', 'system:order:list', '#', 'admin', '2022-10-13 18:14:39', '', null, '');
...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES ('1', '操作日志', '9', 'com.ruoyi.web.controller.monitor.SysOperlogController.clean()', 'POST', '1', 'admin', '研发部门', '/monitor/operlog/clean', '127.0.0.1', '内网IP', '{ }', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:33:25');
INSERT INTO `sys_oper_log` VALUES ('2', '登陆日志', '9', 'com.ruoyi.web.controller.monitor.SysLogininforController.clean()', 'POST', '1', 'admin', '研发部门', '/monitor/logininfor/clean', '127.0.0.1', '内网IP', '{ }', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:33:43');
INSERT INTO `sys_oper_log` VALUES ('3', '部门管理', '3', 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'GET', '1', 'admin', '研发部门', '/system/dept/remove/108', '127.0.0.1', '内网IP', '{ }', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:36:07');
INSERT INTO `sys_oper_log` VALUES ('4', '部门管理', '3', 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'GET', '1', 'admin', '研发部门', '/system/dept/remove/102', '127.0.0.1', '内网IP', '{ }', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:36:09');
INSERT INTO `sys_oper_log` VALUES ('5', '部门管理', '3', 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'GET', '1', 'admin', '研发部门', '/system/dept/remove/107', '127.0.0.1', '内网IP', '{ }', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:36:11');
INSERT INTO `sys_oper_log` VALUES ('6', '部门管理', '3', 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'GET', '1', 'admin', '研发部门', '/system/dept/remove/106', '127.0.0.1', '内网IP', '{ }', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:36:12');
INSERT INTO `sys_oper_log` VALUES ('7', '部门管理', '3', 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'GET', '1', 'admin', '研发部门', '/system/dept/remove/105', '127.0.0.1', '内网IP', '{ }', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:36:14');
INSERT INTO `sys_oper_log` VALUES ('8', '部门管理', '3', 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'GET', '1', 'admin', '研发部门', '/system/dept/remove/104', '127.0.0.1', '内网IP', '{ }', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:36:15');
INSERT INTO `sys_oper_log` VALUES ('9', '部门管理', '3', 'com.ruoyi.web.controller.system.SysDeptController.remove()', 'GET', '1', 'admin', '研发部门', '/system/dept/remove/103', '127.0.0.1', '内网IP', '{ }', '{\r\n  \"msg\" : \"部门存在用户,不允许删除\",\r\n  \"code\" : 301\r\n}', '0', null, '2022-10-13 15:36:17');
INSERT INTO `sys_oper_log` VALUES ('10', '角色管理', '3', 'com.ruoyi.web.controller.system.SysRoleController.remove()', 'POST', '1', 'admin', '研发部门', '/system/role/remove', '127.0.0.1', '内网IP', '{\r\n  \"ids\" : [ \"2\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:38:48');
INSERT INTO `sys_oper_log` VALUES ('11', '部门管理', '2', 'com.ruoyi.web.controller.system.SysDeptController.editSave()', 'POST', '1', 'admin', '研发部门', '/system/dept/edit', '127.0.0.1', '内网IP', '{\r\n  \"deptId\" : [ \"101\" ],\r\n  \"parentId\" : [ \"100\" ],\r\n  \"parentName\" : [ \"若依科技\" ],\r\n  \"deptName\" : [ \"背调总公司\" ],\r\n  \"orderNum\" : [ \"1\" ],\r\n  \"leader\" : [ \"若依\" ],\r\n  \"phone\" : [ \"15888888888\" ],\r\n  \"email\" : [ \"ry@qq.com\" ],\r\n  \"status\" : [ \"0\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:39:50');
INSERT INTO `sys_oper_log` VALUES ('12', '部门管理', '1', 'com.ruoyi.web.controller.system.SysDeptController.addSave()', 'POST', '1', 'admin', '研发部门', '/system/dept/add', '127.0.0.1', '内网IP', '{\r\n  \"parentId\" : [ \"101\" ],\r\n  \"deptName\" : [ \"交付部\" ],\r\n  \"orderNum\" : [ \"1\" ],\r\n  \"leader\" : [ \"\" ],\r\n  \"phone\" : [ \"\" ],\r\n  \"email\" : [ \"\" ],\r\n  \"status\" : [ \"0\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:40:04');
INSERT INTO `sys_oper_log` VALUES ('13', '用户管理', '1', 'com.ruoyi.web.controller.system.SysUserController.addSave()', 'POST', '1', 'admin', '研发部门', '/system/user/add', '127.0.0.1', '内网IP', '{\r\n  \"deptId\" : [ \"200\" ],\r\n  \"userName\" : [ \"交付员\" ],\r\n  \"deptName\" : [ \"交付部\" ],\r\n  \"phonenumber\" : [ \"15988427828\" ],\r\n  \"email\" : [ \"jiaofu@ibeidiao.com\" ],\r\n  \"loginName\" : [ \"jiaofu\" ],\r\n  \"password\" : [ \"123456\" ],\r\n  \"sex\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"roleIds\" : [ \"\" ],\r\n  \"postIds\" : [ \"4\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:41:13');
INSERT INTO `sys_oper_log` VALUES ('14', '角色管理', '1', 'com.ruoyi.web.controller.system.SysRoleController.addSave()', 'POST', '1', 'admin', '研发部门', '/system/role/add', '127.0.0.1', '内网IP', '{\r\n  \"roleName\" : [ \"交付员\" ],\r\n  \"roleKey\" : [ \"system:deliver\" ],\r\n  \"roleSort\" : [ \"2\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"menuIds\" : [ \"1,100,1000,1001,1002,1003,1004,1005,1006,101,1007,1008,1009,1010,1011\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:42:23');
INSERT INTO `sys_oper_log` VALUES ('15', '用户管理', '2', 'com.ruoyi.web.controller.system.SysUserController.editSave()', 'POST', '1', 'admin', '研发部门', '/system/user/edit', '127.0.0.1', '内网IP', '{\r\n  \"userId\" : [ \"100\" ],\r\n  \"deptId\" : [ \"200\" ],\r\n  \"userName\" : [ \"交付员\" ],\r\n  \"dept.deptName\" : [ \"交付部\" ],\r\n  \"phonenumber\" : [ \"15988427828\" ],\r\n  \"email\" : [ \"jiaofu@ibeidiao.com\" ],\r\n  \"loginName\" : [ \"jiaofu\" ],\r\n  \"sex\" : [ \"0\" ],\r\n  \"role\" : [ \"100\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"roleIds\" : [ \"100\" ],\r\n  \"postIds\" : [ \"4\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:42:39');
INSERT INTO `sys_oper_log` VALUES ('16', '用户管理', '2', 'com.ruoyi.web.controller.system.SysUserController.changeStatus()', 'POST', '1', 'admin', '研发部门', '/system/user/changeStatus', '127.0.0.1', '内网IP', '{\r\n  \"userId\" : [ \"100\" ],\r\n  \"status\" : [ \"1\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:53:54');
INSERT INTO `sys_oper_log` VALUES ('17', '用户管理', '2', 'com.ruoyi.web.controller.system.SysUserController.changeStatus()', 'POST', '1', 'admin', '研发部门', '/system/user/changeStatus', '127.0.0.1', '内网IP', '{\r\n  \"userId\" : [ \"100\" ],\r\n  \"status\" : [ \"0\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:54:35');
INSERT INTO `sys_oper_log` VALUES ('18', '角色管理', '4', 'com.ruoyi.web.controller.system.SysRoleController.cancelAuthUser()', 'POST', '1', 'admin', '研发部门', '/system/role/authUser/cancel', '127.0.0.1', '内网IP', '{\r\n  \"roleId\" : [ \"100\" ],\r\n  \"userId\" : [ \"100\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:57:29');
INSERT INTO `sys_oper_log` VALUES ('19', '用户管理', '2', 'com.ruoyi.web.controller.system.SysUserController.editSave()', 'POST', '1', 'admin', '研发部门', '/system/user/edit', '127.0.0.1', '内网IP', '{\r\n  \"userId\" : [ \"100\" ],\r\n  \"deptId\" : [ \"200\" ],\r\n  \"userName\" : [ \"交付员\" ],\r\n  \"dept.deptName\" : [ \"交付部\" ],\r\n  \"phonenumber\" : [ \"15988427828\" ],\r\n  \"email\" : [ \"jiaofu@ibeidiao.com\" ],\r\n  \"loginName\" : [ \"jiaofu\" ],\r\n  \"sex\" : [ \"0\" ],\r\n  \"role\" : [ \"100\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"roleIds\" : [ \"100\" ],\r\n  \"postIds\" : [ \"4\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:57:42');
INSERT INTO `sys_oper_log` VALUES ('20', '部门管理', '2', 'com.ruoyi.web.controller.system.SysDeptController.editSave()', 'POST', '1', 'admin', '研发部门', '/system/dept/edit', '127.0.0.1', '内网IP', '{\r\n  \"deptId\" : [ \"100\" ],\r\n  \"parentId\" : [ \"0\" ],\r\n  \"parentName\" : [ \"无\" ],\r\n  \"deptName\" : [ \"背调科技\" ],\r\n  \"orderNum\" : [ \"0\" ],\r\n  \"leader\" : [ \"若依\" ],\r\n  \"phone\" : [ \"15888888888\" ],\r\n  \"email\" : [ \"ry@qq.com\" ],\r\n  \"status\" : [ \"0\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 15:58:54');
INSERT INTO `sys_oper_log` VALUES ('21', '字典类型', '3', 'com.ruoyi.web.controller.system.SysDictTypeController.remove()', 'POST', '1', 'admin', '研发部门', '/system/dict/remove', '127.0.0.1', '内网IP', '{\r\n  \"ids\" : [ \"1\" ]\r\n}', '{\r\n  \"msg\" : \"用户性别已分配,不能删除\",\r\n  \"code\" : 500\r\n}', '0', null, '2022-10-13 15:59:21');
INSERT INTO `sys_oper_log` VALUES ('22', '字典类型', '3', 'com.ruoyi.web.controller.system.SysDictTypeController.remove()', 'POST', '1', 'admin', '研发部门', '/system/dict/remove', '127.0.0.1', '内网IP', '{\r\n  \"ids\" : [ \"1\" ]\r\n}', '{\r\n  \"msg\" : \"用户性别已分配,不能删除\",\r\n  \"code\" : 500\r\n}', '0', null, '2022-10-13 15:59:39');
INSERT INTO `sys_oper_log` VALUES ('23', '菜单管理', '1', 'com.ruoyi.web.controller.system.SysMenuController.addSave()', 'POST', '1', 'admin', '研发部门', '/system/menu/add', '127.0.0.1', '内网IP', '{\r\n  \"parentId\" : [ \"1\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"订单列表\" ],\r\n  \"url\" : [ \"/system/order\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"system:order\" ],\r\n  \"orderNum\" : [ \"9\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 16:12:05');
INSERT INTO `sys_oper_log` VALUES ('24', '菜单管理', '2', 'com.ruoyi.web.controller.system.SysMenuController.editSave()', 'POST', '1', 'admin', '研发部门', '/system/menu/edit', '127.0.0.1', '内网IP', '{\r\n  \"menuId\" : [ \"2000\" ],\r\n  \"parentId\" : [ \"1\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"订单列表\" ],\r\n  \"url\" : [ \"/system/order\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"system:order:view\" ],\r\n  \"orderNum\" : [ \"9\" ],\r\n  \"icon\" : [ \"#\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 16:22:46');
INSERT INTO `sys_oper_log` VALUES ('25', '字典类型', '1', 'com.ruoyi.web.controller.system.SysDictTypeController.addSave()', 'POST', '1', 'admin', '研发部门', '/system/dict/add', '127.0.0.1', '内网IP', '{\r\n  \"dictName\" : [ \"订单状态\" ],\r\n  \"dictType\" : [ \"sys_order_status\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 16:35:08');
INSERT INTO `sys_oper_log` VALUES ('26', '字典数据', '1', 'com.ruoyi.web.controller.system.SysDictDataController.addSave()', 'POST', '1', 'admin', '研发部门', '/system/dict/data/add', '127.0.0.1', '内网IP', '{\r\n  \"dictLabel\" : [ \"待授权\" ],\r\n  \"dictValue\" : [ \"2\" ],\r\n  \"dictType\" : [ \"sys_order_status\" ],\r\n  \"cssClass\" : [ \"\" ],\r\n  \"dictSort\" : [ \"0\" ],\r\n  \"listClass\" : [ \"default\" ],\r\n  \"isDefault\" : [ \"Y\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 16:36:46');
INSERT INTO `sys_oper_log` VALUES ('27', '字典数据', '1', 'com.ruoyi.web.controller.system.SysDictDataController.addSave()', 'POST', '1', 'admin', '研发部门', '/system/dict/data/add', '127.0.0.1', '内网IP', '{\r\n  \"dictLabel\" : [ \"调查中\" ],\r\n  \"dictValue\" : [ \"3\" ],\r\n  \"dictType\" : [ \"sys_order_status\" ],\r\n  \"cssClass\" : [ \"\" ],\r\n  \"dictSort\" : [ \"1\" ],\r\n  \"listClass\" : [ \"\" ],\r\n  \"isDefault\" : [ \"Y\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 16:37:05');
INSERT INTO `sys_oper_log` VALUES ('28', '岗位管理', '5', 'com.ruoyi.web.controller.system.SysPostController.export()', 'POST', '1', 'admin', '研发部门', '/system/post/export', '127.0.0.1', '内网IP', '{\r\n  \"postCode\" : [ \"\" ],\r\n  \"postName\" : [ \"\" ],\r\n  \"status\" : [ \"\" ]\r\n}', '{\r\n  \"msg\" : \"530c7ca8-1853-4716-bd64-ba2a7acd18d1_岗位数据.xlsx\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 16:44:21');
INSERT INTO `sys_oper_log` VALUES ('29', '代码生成', '6', 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', '1', 'admin', '研发部门', '/tool/gen/importTable', '127.0.0.1', '内网IP', '{\r\n  \"tables\" : [ \"sys_order\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 16:58:58');
INSERT INTO `sys_oper_log` VALUES ('30', '代码生成', '8', 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', '1', 'admin', '研发部门', '/tool/gen/batchGenCode', '127.0.0.1', '内网IP', '{\r\n  \"tables\" : [ \"sys_order\" ]\r\n}', 'null', '0', null, '2022-10-13 16:59:04');
INSERT INTO `sys_oper_log` VALUES ('31', '代码生成', '8', 'com.ruoyi.generator.controller.GenController.genCode()', 'GET', '1', 'admin', '研发部门', '/tool/gen/genCode/sys_order', '127.0.0.1', '内网IP', '{ }', 'null', '0', null, '2022-10-13 17:01:14');
INSERT INTO `sys_oper_log` VALUES ('32', '角色管理', '2', 'com.ruoyi.web.controller.system.SysRoleController.authDataScopeSave()', 'POST', '1', 'admin', '研发部门', '/system/role/authDataScope', '127.0.0.1', '内网IP', '{\r\n  \"roleId\" : [ \"100\" ],\r\n  \"roleName\" : [ \"交付员\" ],\r\n  \"roleKey\" : [ \"system:deliver\" ],\r\n  \"dataScope\" : [ \"5\" ],\r\n  \"deptIds\" : [ \"\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 18:02:36');
INSERT INTO `sys_oper_log` VALUES ('33', '角色管理', '2', 'com.ruoyi.web.controller.system.SysRoleController.authDataScopeSave()', 'POST', '1', 'admin', '研发部门', '/system/role/authDataScope', '127.0.0.1', '内网IP', '{\r\n  \"roleId\" : [ \"100\" ],\r\n  \"roleName\" : [ \"交付员\" ],\r\n  \"roleKey\" : [ \"system:deliver\" ],\r\n  \"dataScope\" : [ \"1\" ],\r\n  \"deptIds\" : [ \"\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 18:02:42');
INSERT INTO `sys_oper_log` VALUES ('34', '角色管理', '2', 'com.ruoyi.web.controller.system.SysRoleController.editSave()', 'POST', '1', 'admin', '研发部门', '/system/role/edit', '127.0.0.1', '内网IP', '{\r\n  \"roleId\" : [ \"100\" ],\r\n  \"roleName\" : [ \"交付员\" ],\r\n  \"roleKey\" : [ \"system:deliver\" ],\r\n  \"roleSort\" : [ \"2\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"menuIds\" : [ \"1,2000\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 18:03:03');
INSERT INTO `sys_oper_log` VALUES ('35', '重置密码', '2', 'com.ruoyi.web.controller.system.SysUserController.resetPwd()', 'GET', '1', 'admin', '研发部门', '/system/user/resetPwd/100', '127.0.0.1', '内网IP', '{ }', '\"system/user/resetPwd\"', '0', null, '2022-10-13 18:05:02');
INSERT INTO `sys_oper_log` VALUES ('36', '岗位管理', '3', 'com.ruoyi.web.controller.system.SysPostController.remove()', 'POST', '1', 'admin', '研发部门', '/system/post/remove', '127.0.0.1', '内网IP', '{\r\n  \"ids\" : [ \"4\" ]\r\n}', '{\r\n  \"msg\" : \"普通员工已分配,不能删除\",\r\n  \"code\" : 500\r\n}', '0', null, '2022-10-13 18:06:24');
INSERT INTO `sys_oper_log` VALUES ('37', '字典类型', '2', 'com.ruoyi.web.controller.system.SysDictTypeController.editSave()', 'POST', '1', 'admin', '研发部门', '/system/dict/edit', '127.0.0.1', '内网IP', '{\r\n  \"dictId\" : [ \"100\" ],\r\n  \"dictName\" : [ \"订单状态\" ],\r\n  \"dictType\" : [ \"sys_order_status\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"订单状态列表\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 18:07:19');
INSERT INTO `sys_oper_log` VALUES ('38', '用户管理', '2', 'com.ruoyi.web.controller.system.SysUserController.editSave()', 'POST', '1', 'admin', '研发部门', '/system/user/edit', '127.0.0.1', '内网IP', '{\r\n  \"userId\" : [ \"1\" ],\r\n  \"deptId\" : [ \"103\" ],\r\n  \"userName\" : [ \"若依\" ],\r\n  \"dept.deptName\" : [ \"研发部门\" ],\r\n  \"phonenumber\" : [ \"15888888888\" ],\r\n  \"email\" : [ \"ry@163.com\" ],\r\n  \"loginName\" : [ \"admin\" ],\r\n  \"sex\" : [ \"1\" ],\r\n  \"role\" : [ \"1\" ],\r\n  \"remark\" : [ \"管理员\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"roleIds\" : [ \"1\" ],\r\n  \"postIds\" : [ \"1\" ]\r\n}', 'null', '1', '不允许操作超级管理员用户', '2022-10-13 18:07:59');
INSERT INTO `sys_oper_log` VALUES ('39', '角色管理', '2', 'com.ruoyi.web.controller.system.SysRoleController.editSave()', 'POST', '1', 'admin', '研发部门', '/system/role/edit', '127.0.0.1', '内网IP', '{\r\n  \"roleId\" : [ \"100\" ],\r\n  \"roleName\" : [ \"交付员\" ],\r\n  \"roleKey\" : [ \"system:deliver\" ],\r\n  \"roleSort\" : [ \"2\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"menuIds\" : [ \"1,2000\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 18:08:39');
INSERT INTO `sys_oper_log` VALUES ('40', '角色管理', '2', 'com.ruoyi.web.controller.system.SysRoleController.editSave()', 'POST', '1', 'admin', '研发部门', '/system/role/edit', '127.0.0.1', '内网IP', '{\r\n  \"roleId\" : [ \"100\" ],\r\n  \"roleName\" : [ \"交付员\" ],\r\n  \"roleKey\" : [ \"system:deliver,system:order:list\" ],\r\n  \"roleSort\" : [ \"2\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"menuIds\" : [ \"1,2000\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 18:10:44');
INSERT INTO `sys_oper_log` VALUES ('41', '菜单管理', '1', 'com.ruoyi.web.controller.system.SysMenuController.addSave()', 'POST', '1', 'admin', '研发部门', '/system/menu/add', '127.0.0.1', '内网IP', '{\r\n  \"parentId\" : [ \"2\" ],\r\n  \"menuType\" : [ \"F\" ],\r\n  \"menuName\" : [ \"订单列表\" ],\r\n  \"url\" : [ \"\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"system:order:list\" ],\r\n  \"orderNum\" : [ \"1\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 18:13:39');
INSERT INTO `sys_oper_log` VALUES ('42', '菜单管理', '1', 'com.ruoyi.web.controller.system.SysMenuController.addSave()', 'POST', '1', 'admin', '研发部门', '/system/menu/add', '127.0.0.1', '内网IP', '{\r\n  \"parentId\" : [ \"2000\" ],\r\n  \"menuType\" : [ \"F\" ],\r\n  \"menuName\" : [ \"订单列表查询\" ],\r\n  \"url\" : [ \"\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"system:order:list\" ],\r\n  \"orderNum\" : [ \"1\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 18:14:40');
INSERT INTO `sys_oper_log` VALUES ('43', '角色管理', '2', 'com.ruoyi.web.controller.system.SysRoleController.editSave()', 'POST', '1', 'admin', '研发部门', '/system/role/edit', '127.0.0.1', '内网IP', '{\r\n  \"roleId\" : [ \"100\" ],\r\n  \"roleName\" : [ \"交付员\" ],\r\n  \"roleKey\" : [ \"system:deliver,system:order:list\" ],\r\n  \"roleSort\" : [ \"2\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"remark\" : [ \"\" ],\r\n  \"menuIds\" : [ \"1,2000,2002\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2022-10-13 18:15:01');
...
CREATE TABLE `sys_order` (
  ...
  `candidateName` varchar(32) COLLATE utf8mb4_bin DEFAULT NULL,
  `pdfPath` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '报告地址',
...
-- ----------------------------
INSERT INTO `sys_order` VALUES ('1', '2', 'SPE20221013', '陈强', '', '2022-10-13 17:05:04', '2022-10-13 17:05:05', '1', '1', '1');
INSERT INTO `sys_order` VALUES ('2', '3', 'WIP20221013', '黄小英', null, '2022-10-13 17:40:18', '2022-10-13 17:40:21', '1', '1', '1');
...
CREATE TABLE `sys_role` (
  ...
  `remark` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='角色信息表';

-- ----------------------------
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '管理员', 'admin', '1', '1', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '管理员');
INSERT INTO `sys_role` VALUES ('2', '普通角色', 'common', '0', '2', '1', '2', 'admin', '2018-03-16 11:33:00', 'admin', '2022-10-13 15:15:03', '普通角色');
INSERT INTO `sys_role` VALUES ('100', '交付员', 'system:deliver,system:order:list', '2', '1', '0', '0', 'admin', '2022-10-13 15:42:23', 'admin', '2022-10-13 18:15:01', '');
...
CREATE TABLE `sys_user` (
  ...
  `remark` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='用户信息表';

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '/profile/avatar/2022/10/13/20d5817b34a505cb444ab67e7dd77034.png', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2022-10-13 18:15:06', 'admin', '2018-03-16 11:33:00', 'ry', '2022-10-13 18:15:06', '管理员');
INSERT INTO `sys_user` VALUES ('2', '105', 'ry', '若依', '00', 'ry@qq.com', '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '2', '127.0.0.1', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', 'admin', '2022-10-13 15:14:17', '测试员');
INSERT INTO `sys_user` VALUES ('100', '200', 'jiaofu', '交付员', '00', 'jiaofu@ibeidiao.com', '15988427828', '0', '', 'b994beee8a3426c6634733766ae7c996', 'b533b9', '0', '0', '127.0.0.1', '2022-10-13 18:15:29', 'admin', '2022-10-13 15:41:13', 'admin', '2022-10-13 18:15:28', '');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('d0779760-c15a-4d12-a2ad-b0394e4503eb', 'jiaofu', '交付部', '127.0.0.1', '内网IP', 'Chrome 10', 'Windows 10', 'on_line', '2022-10-14 13:59:53', '2022-10-14 13:59:53', '1800000');
